...
window.scrollReveal = function(t) {
    ...
    return e.prototype = {
        ...
        init: function() {
            ...
            this.elems = this.docElem.querySelectorAll("[data-scroll-reveal]"),
            ...
            var r = function() { e.scrolled || (e.scrolled = !0, o(function() { e._scrollPage() })) },
                n = function() {
        ...
        parseLanguage: function(t) {
            ...
            return i = e(i), i.forEach(function(t, e) {
                switch (t) {
                    case "enter":
                        return o.enter = i[e + 1], void 0;
                    case "after":
                        return o.after = i[e + 1], void 0;
                    case "wait":
                        return o.after = i[e + 1], void 0;
                    case "move":
                        return o.move = i[e + 1], void 0;
                    case "ease":
                        return o.move = i[e + 1], o.ease = "ease", void 0;
                    case "ease-in":
                        return o.move = i[e + 1], o.easing = "ease-in", void 0;
                    case "ease-in-out":
                        return o.move = i[e + 1], o.easing = "ease-in-out", void 0;
                    case "ease-out":
                        return o.move = i[e + 1], o.easing = "ease-out", void 0;
                    case "over":
                        return o.over = i[e + 1], void 0;
                    default:
                        return
                }
            }), o
