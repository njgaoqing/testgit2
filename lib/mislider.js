    ...
    var MiSlider = function(stageEl, options) {
                    ...
                    if (o.navButtons) {
                        ...
                        o.navButtons.fadeTo(100, 1,
                            function() {
                                ...
                                o.navButtons.fadeTo(100, 1, function() { //修改0-》1
                                    // Do transition
                                    o.animateSlides(indexToAdjusted, function() {
                                        if (o.stage.find(":hover").length ||
                                            ...
                                            o.navButtons.fadeTo(400, 1, after); //o.navButtonsOpacity
                                        } else {
                                            after();
                                        }
        ...
        o.addNavButtons = function(element) {
            ...
            navButtons = $("<div class='" +
                ...
                "'><a href='#' class='" +
                o.classPrev +
                "'><div style='background-size: 18px 32px;background-image: url(./images/mis-prev-icon.png); background-repeat: no-repeat;width: 18px;height: 32px;'></div></a><a href='#' class='" +
                o.classNext +
                "'><div style='background-size: 18px 32px;background-image: url(./images/mis-next-icon.png);background-repeat: no-repeat;width: 18px;height: 32px;'></div></a></div>");
